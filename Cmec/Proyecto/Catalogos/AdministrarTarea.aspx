...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
            <asp:Label ID="lblAdministrarTareas" runat="server" Text="Administrar Tareas" Font-Size="Large" ForeColor="Black"></asp:Label>
        </center>
            </div>
            <%-- fin titulo pantalla --%>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12" style="text-align: center; overflow-y: auto;">
                ...
                <asp:Repeater ID="rpTarea" runat="server" OnItemDataBound="rpTarea_ItemDataBound" >
                    <HeaderTemplate>
                        <table id="tblTarea" class="row-border table-striped">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Descripción</th>
