<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="NuevaTarea.aspx.cs" Inherits="Proyecto.Catalogos.Tareas.NuevaTarea" %>
   ...
   <div class="divRedondo">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
                        <asp:Label ID="lblNuevoTarea" runat="server" Text="Nueva Tarea" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
            </div>
            <%-- fin titulo accion --%>
     ...
     <script type="text/javascript">
        ...
        */
        function validarTexto(txtBox) {
            ...
            var DescripcionTareaIncorrecto = document.getElementById('<%= divDescripcionTareaIncorrecto.ClientID %>');

            if (txtBox.value != "") {
                txtBox.className = "form-control";

                DescripcionTareaIncorrecto.style.display = 'none';
            } else {
                txtBox.className = "form-control alert-danger";
                DescripcionTareaIncorrecto.style.display = 'block';
            }
        }
    </script>
</asp:Content>
