<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="NuevoActivo.aspx.cs" Inherits="Proyecto.Catalogos.Activos.NuevoActivo" %>
...
<div class="divRedondo">
    ...
    <%-- titulo accion--%>
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
                        <asp:Label ID="lblNuevoActivo" runat="server" Text="Nuevo Activo" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
            </div>
            <%-- fin titulo accion --%>
    ...
    <%-- campos a llenar --%>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12" style="margin-bottom:4px;">
                ...
                <div class="col-md-4 col-xs-4 col-sm-4">
                    <asp:TextBox  class="form-control" ID="txtPlacaActivo"  runat="server" onkeydown = "return (!(event.keyCode>=65) && event.keyCode!=32);"></asp:TextBox>                              
                </div>
                <div id="divPlacaActivoIncorrecto" runat="server" style="display: none" class="col-md-6 col-xs-6 col-sm-6">
                    <asp:Label ID="lblPlacaActivoIncorrecto" runat="server" Font-Size="Small" class="label alert-danger" Text="Espacio Obligatorio" ForeColor="Red"></asp:Label>
                </div>
            </div>
            <%-- campo serie --%>
            <div class="col-md-12 col-xs-12 col-sm-12" style="margin-bottom:4px;">
    ...
    <script type="text/javascript">
        ...
        */
        function validarTexto(txtBox,id) {
            var PlacaActivoIncorrecto = document.getElementById('<%= divPlacaActivoIncorrecto.ClientID %>');
            ...
            if (txtBox.value != "") {
                ...
                if (id == 'placa')
                    PlacaActivoIncorrecto.style.display = 'none';
                if (id == 'serie')
                ...
                if (id == 'placa')
                    PlacaActivoIncorrecto.style.display = 'block';
                if (id == 'serie')
