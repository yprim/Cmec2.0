<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="EliminarActivo.aspx.cs" Inherits="Proyecto.Catalogos.Activos.EliminarActivo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12 col-xs-12 col-sm-12">
        <center>
                <asp:Label ID="lblEliminarTarea" runat="server" Text="Eliminar Activo" Font-Size="Large" ForeColor="Black"></asp:Label>
        </center>
    </div>
            <%-- fin titulo accion --%>
