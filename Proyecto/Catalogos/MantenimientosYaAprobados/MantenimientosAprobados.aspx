<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="MantenimientosAprobados.aspx.cs" Inherits="Proyecto.Catalogos.PlanMantenimientoPreventivo.MantenimietosAprobados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
            <asp:Label ID="lblAdministrarMantenimientos" runat="server" Text="Mantenimientos que ya se aprobaron" Font-Size="Large" ForeColor="Black"></asp:Label>
        </center>
            </div>
            <%-- fin titulo pantalla --%>
